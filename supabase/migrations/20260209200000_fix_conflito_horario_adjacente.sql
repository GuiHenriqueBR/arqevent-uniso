-- Fix: permitir palestras consecutivas (ex: 7:40-9:00 e 9:00-10:20)
-- A verificação anterior tratava horários adjacentes como conflito
-- quando havia diferença de segundos nos timestamps.
-- Agora usa margem de 1 minuto para permitir adjacência.
...
BEGIN
  ...
  -- Usa margem de 1 minuto para permitir palestras consecutivas
  -- (ex: 7:40-9:00 e 9:00-10:20 NAO sao conflito)
  ...
  -- 5. Bloquear confirmados antes de contar
  PERFORM 1
  FROM inscricoes_palestra
