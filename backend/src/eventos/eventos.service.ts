  ...
  async create(dto: CreateEventoDto, organizadorId: string) {
    const evento = await this.prisma.evento.create({
      data: {
        ...
        banner_galeria: dto.banner_galeria,
        destaque: dto.destaque ?? false,
        status_manual: dto.status_manual || "AUTO",
        cta_label: dto.cta_label,
        cta_sec_label: dto.cta_sec_label,
        cta_sec_url: dto.cta_sec_url,
        compartilhar_url: dto.compartilhar_url,
  ...
  async update(
    ...
    return this.prisma.evento.update({
      ...
      data: {
        ...
        status_manual: dto.status_manual,
        cta_label: dto.cta_label,
        cta_sec_label: dto.cta_sec_label,
        cta_sec_url: dto.cta_sec_url,
        compartilhar_url: dto.compartilhar_url,
